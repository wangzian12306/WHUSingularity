...
import com.lubover.singularity.user.mapper.InventoryChangeLogMapper;
import com.lubover.singularity.user.mapper.ProductInventoryMapper;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    public void addInventory(Long productId, Long quantity, String remark) {
        ...
        Long operatorId = AuthRequestContext.getCurrentUserId();
    ...
    private String getShopNameByMerchantId(Long merchantId) {
        User user = userService.getUserById(merchantId);
