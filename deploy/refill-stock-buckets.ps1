...
$body1 = @{ slotId = "bucket-1"; redisKey = "stock:bucket-1"; quantity = $Quantity; overwrite = $true } | ConvertTo-Json
$body2 = @{ slotId = "bucket-2"; redisKey = "stock:bucket-2"; quantity = $Quantity; overwrite = $true } | ConvertTo-Json

Write-Host "[2/2] Preheating Redis via $StockBaseUrl/api/stock/slots/preheat"
