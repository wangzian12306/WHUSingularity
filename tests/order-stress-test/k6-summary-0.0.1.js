/* Vendored from https://github.com/grafana/jslib.k6.io (k6-summary 0.0.1). ESM export; use offline in Docker without jslib.k6.io. */
...
export { humanizeValue, generateTextSummary as textSummary, generateJUnitXML as jUnit };
